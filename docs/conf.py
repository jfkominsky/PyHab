...
on_rtd = os.environ.get('READTHEDOCS') == 'True'  # For RTD vs. not.
if on_rtd:
    html_theme = 'default'
else:
...
project = u'PyHab'
copyright = u'2018, Jonathan F. Kominsky'
author = u'Jonathan F. Kominsky'
...
latex_documents = [
    (master_doc, 'PyHab.tex', u'PyHab Documentation',
     u'Jonathan F. Kominsky', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyhab', u'PyHab Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PyHab', u'PyHab Documentation',
     author, 'PyHab', 'Live infant looking-time coding and stimulus presentation.',
     'Miscellaneous'),
]
