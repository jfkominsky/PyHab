...
<li><b>I strongly recommend using PsychoPy version 2024.2.0 or later</b> (as of January 2025). Version 0.11 has problems with Psychopy 2025.2+, but 0.12.0 is compatible with every version of PsychoPy from 2024.2 forward</li>
...
<li>PyHab is still very much in development! Don't be shy about contacting me for feature requests. It is now much more flexible than it was, but there are still some designs it cannot produce I'm sure, and I would love to hear about them. You can also make feature requests in the <a href="https://github.com/jfkominsky/PyHab/issues">"issues" here on GitHub</a></li>
...
<li>There is a complex fix for some movie and audio playback issues that has the end result of adding a ~100ms delay to all movie playback, however it appears seamless and the timing data captures the actual onset of the movie file itself accurately.</li>
</ul>
