...
stimPres = False #For determining if the program is for stimulus presentation (True) or if it's just coding looking times (False)
...
screenIndex = 1 #which monitor stimuli are presented on. 1 for secondary monitor, 0 for primary monitor.
